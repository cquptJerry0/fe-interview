# 前端手写题 3 题：事件通信、商品列表 diff、请求去重缓存与超时保护（小红书暑期笔试）
...
console.log(diffGoods(oldList, newList))
// {
//   add: [{ id: 3, name: 'C', price: 30 }],
//   remove: [{ id: 2, name: 'B', price: 20 }],
//   update: [
//     {
//       id: 1,
//       changes: {
//         price: { before: 10, after: 15 }
//       }
//     }
//   ]
// }
